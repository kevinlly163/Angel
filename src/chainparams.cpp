...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "2 28,2018. The Happyangel released, www.Happyangel.org";
        CTransaction txNew;
        ...
        genesis.nTime    = GENESIS_BLOCK_TIME;
             ...
             vSeeds.push_back(CDNSSeedData("47.52.160.38",  "47.52.160.38"));
		vSeeds.push_back(CDNSSeedData("47.75.47.30",  "47.75.47.30"));
...
public:
    CMainParams() {
      ...
      //  nLastPOWBlock = std::numeric_limits<int>::max();
        ...
        assert(hashGenesisBlock == uint256("0xa640f532f3715d7aebc282721380cb9cadbbced03e908b59fac72c77cd089ac2"));
        assert(genesis.hashMerkleRoot == uint256("0x3697f961f05a5db73ead2a659031acf34790ddcc9890da83b313588999ae26eb"));
...
public:
    CTestNetParams() {
        ...
        assert(hashGenesisBlock == uint256("0x2cb14bc415110594a9175bfac93b7626d548542c3d5aaec9ae0fc72c259d57b9"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("0x295c6a178d3f2ed345c2b2d2c78dd846bfdc4e237d4e2b480ac551ff4dff89ec"));
